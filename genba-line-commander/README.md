...
現場監督が職人一人一人に電話する手間を、ワンタップの一斉通知で自動化します。

### 3つの通知タイプ
| タイプ | アイコン | カラー | 用途 |
|--------|---------|--------|------|
| 雨天中止 | 🌧️ | 赤 #FF4444 | 翌日の作業中止を通知 |
| 工程変更 | 📅 | 黄 #FFB300 | 日程変更を視覚的に伝達 |
| 図面更新 | 📄 | 青 #2196F3 | 最新図面をワンタップで閲覧 |
...
### Schedule シート（工程管理）
| scheduleId | projectId | taskName | date | status | note |
|------------|-----------|----------|------|--------|------|
| S001 | P001 | モルタル造形 | 2025-01-25 | scheduled | |
| S002 | P001 | 配筋検査 | 2025-01-26 | scheduled | AM |

※ 中止通知時に該当日のタスクが自動表示されます
